...
class RejectedDetailWidget extends StatelessWidget {
  const RejectedDetailWidget({
    super.key,
  });
...
class RejectedDetail extends StatefulWidget {
  ...
  @override
  State<RejectedDetail> createState() => _SignedContractPropertyDetailState();
}

class _SignedContractPropertyDetailState extends State<RejectedDetail>
                ...
                children: [
                          ...
                          children: [
                            CustomHorizontalTextRow(
                              ...
                              trailingChild: CustomElevatedButton(
                                ...
                                borderRadius: 6,
                                disabledBackgroundColor: context.error500,
                            ...
                            CustomHorizontalTextRow(
                              leadingTitle: 'Asking Price',
                              leadingStyle: context.sixteen400,
                              trailingStyle: context.sixteen600,
                              trailingTitle: '\$2,000,000',
                            ),
                            VerticalSpacing(of: 16),
                            CustomHorizontalTextRow(
                              leadingChild: CustomHorizontalTextRow(
                                mainAxisAlignment: MainAxisAlignment.start,
                                leadingTitle: 'Current Offer by ',
                                leadingStyle: context.sixteen400,
                                trailingTitle: 'You',
                                trailingStyle: context.sixteen500
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        TextSwitchWidget(
                          title: 'I want to make new offer',
                          onChanged: (p0) {},
                          value: true,
                          padding: EdgeInsets.zero,
                        ),
                        CustomHorizontalTextRow(
                          leadingTitle: 'Min. Submittable Offer',
                          leadingStyle: context.sixteen400,
                          trailingStyle: context.sixteen400,
                          trailingTitle: '\$1,551,000',
                        ),
                        VerticalSpacing(of: 16),
                        CustomHorizontalTextRow(
                          leadingTitle: 'Submitted Offers',
                          leadingStyle: context.sixteen400,
                          trailingStyle:
                        ...
                        VerticalSpacing(of: 16),
                        CustomTextFormField(
                          hintText: 'ex. \$1,551,000',
                        ),
                        VerticalSpacing(of: 16),
                        CustomOutlinedButton.custom(
                          text: 'Submit a New Offer',
                          onPressed: () {},
                        ),
                      ],
                    ),
        ...
        SizedBox(
          ...
          child: ClipRRect(
            ...
            child: DataTable(
              columnSpacing: 150,
              horizontalMargin: 10,
              headingTextStyle: context.sixteen600,
                ...
                (index) => DataRow(
                  cells: [
                    ...
                    DataCell(
                      Text(
                        'Rejected',
                        style: context.sixteen400.withColor(context.error500),
                      ),
                    ),
                  ],
                ),
