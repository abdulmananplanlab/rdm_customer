...
class PendingDetailWidget extends StatelessWidget {
  const PendingDetailWidget({
    super.key,
  });
...
class PendingDetail extends StatefulWidget {
  ...
  @override
  State<PendingDetail> createState() => _SignedContractPropertyDetailState();
}

class _SignedContractPropertyDetailState extends State<PendingDetail>
                    ...
                    child: Column(
                      children: [
                        CustomCheckBox(
                          ...
                          child: Text.rich(
                            TextSpan(
                              text: 'I confirm that I have read and',
