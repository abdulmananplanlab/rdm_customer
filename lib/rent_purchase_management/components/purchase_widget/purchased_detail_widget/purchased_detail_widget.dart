...
class PurchasedDetailWidget extends StatelessWidget {
  const PurchasedDetailWidget({
    super.key,
  });
...
class PurchasedDetail extends StatefulWidget {
  const PurchasedDetail({super.key});

  @override
  State<PurchasedDetail> createState() => _SignedContractPropertyDetailState();
}

class _SignedContractPropertyDetailState extends State<PurchasedDetail>
