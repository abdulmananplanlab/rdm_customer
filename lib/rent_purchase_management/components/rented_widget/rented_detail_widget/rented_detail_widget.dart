...
class RentedDetailWidget extends StatelessWidget {
  const RentedDetailWidget({
    super.key,
  });
...
class RentedDetail extends StatefulWidget {
  const RentedDetail({super.key});

  @override
  State<RentedDetail> createState() => _SignedContractPropertyDetailState();
}

class _SignedContractPropertyDetailState extends State<RentedDetail>
