...
class SignedPropertyDetail extends StatefulWidget {
  const SignedPropertyDetail({super.key});

  @override
  State<SignedPropertyDetail> createState() =>
      _SignedContractPropertyDetailState();
}

class _SignedContractPropertyDetailState extends State<SignedPropertyDetail>
                ...
                child: Column(
                  children: [
                    CustomHorizontalTextRow(
                      ...
                      trailingTitle: '\$ 3,123/month',
                    ),
                    VerticalSpacing(of: 16),
                    CustomHorizontalTextRow(
                      leadingTitle: 'Time Period',
                      leadingStyle: context.sixteen600,
                      trailingStyle:
                          context.sixteen400.withColor(context.grey500),
                      trailingTitle: 'Dec 23 - Jun 24',
                    ),
                    VerticalSpacing(of: 16),
                    CustomListTile(
                      crossAxisAlignment: CrossAxisAlignment.start,
