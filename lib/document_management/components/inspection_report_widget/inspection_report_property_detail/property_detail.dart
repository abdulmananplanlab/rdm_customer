...
class InspectionPropertyDetail extends StatefulWidget {
  const InspectionPropertyDetail({super.key});

  @override
  State<InspectionPropertyDetail> createState() =>
      _SignedContractPropertyDetailState();
}

class _SignedContractPropertyDetailState extends State<InspectionPropertyDetail>
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    CustomHorizontalTextRow(
                      leadingTitle: 'Inspector Details',
                      leadingStyle: context.sixteen400,
                    ),
                    VerticalSpacing(of: 16),
                    CustomSideBorderWidget(
                    ...
                    VerticalSpacing(of: 16),
                    CustomHorizontalTextRow(
                      leadingTitle: 'Inspection Time:',
                      leadingStyle: context.sixteen400,
                      trailingStyle: context.sixteen400,
                      trailingTitle: '10:30 AM',
                    ),
                    VerticalSpacing(of: 16),
                    CustomHorizontalTextRow(
                      leadingTitle: 'Inspection Date:',
                      leadingStyle: context.sixteen400,
                      trailingStyle: context.sixteen400,
                      trailingTitle: 'Dec 29,2023',
                    ),
                    VerticalSpacing(of: 16),
