...
class PaymentPropertyDetail extends StatefulWidget {
  const PaymentPropertyDetail({super.key});

  @override
  State<PaymentPropertyDetail> createState() =>
      _SignedContractPropertyDetailState();
}

class _SignedContractPropertyDetailState extends State<PaymentPropertyDetail>
