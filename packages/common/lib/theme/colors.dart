...
extension AppColorsContext on BuildContext {
  Color get primary500 => const Color(0xFF4DAF50);

  Color get primary50 => const Color(0xFFEDF7EE);

  Color get success50 => const Color(0xFFECF6E6);

  Color get primary700 => const Color(0xFF377C39);
  ...
  Color get grey300 => const Color(0xFFB0B3B0);

  Color get grey500 => const Color(0xFF626962);

  Color get grey400 => const Color(0xFF898F89);
